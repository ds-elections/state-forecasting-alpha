...
Results <- Results %>%
  ...
  mutate(perc_changeLag = lag(perc_change, 120),
         ...
         perc_prez_Dem = Prez_Dem/(Prez_Dem + Prez_Repub),
...
Results[c("Leg_Dem",
          ...
          "US_Sen_Repub",
          "US_Sen2_Dem",
          "US_Sen2_Repub")][is.na(Results[c("Leg_Dem",
                                      "Leg_Repub",
                                      "Prez_Dem",
                                      "Prez_Repub",
                                      "incumbency",
...
Results[c("perc_Dem",
          ...
          "perc_sen_Dem",
          "perc_sen2_Dem",
          "perc_gub_Dem")][is.na(Results[c("perc_Dem",
                                           "perc_Repub",
                                           "perc_prez_Dem",
                                           "perc_sen_Dem",
                                           "perc_sen2_Dem",
                                           "perc_gub_Dem")])] <- .5
Results["Leg_winner"][is.na(Results["Leg_winner"])] <- "No election"
```
...
```{r, warning=FALSE, message=FALSE}
m1 <- lmer(perc_Dem ~ incumbentparty + (Approve|prez_party), Results)
