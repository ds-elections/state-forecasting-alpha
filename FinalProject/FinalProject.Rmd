...
# I will also manually add a row for senatorial district 10 in 1968 with NAs because this data entry is missing.

LegResults6814 <- rbind(LegResults6814, c(1968, "SEN", 10, NA, NA, NA, NA, NA))
LegResults6814$year <- as.numeric(as.character(LegResults6814$year))
LegResults6814$prez_party <- as.numeric(as.character(LegResults6814$prez_party))
LegResults6814$District <- as.numeric(as.character(LegResults6814$District))
LegResults6814$mid_penalty <- as.numeric(as.character(LegResults6814$mid_penalty))
LegResults6814$incumbent <- as.numeric(as.character(LegResults6814$incumbent))
LegResults6814$Dem <- as.numeric(as.character(LegResults6814$Dem))
LegResults6814$Repub <- as.numeric(as.character(LegResults6814$Repub))
```
...
Results <- Results %>%
  ...
  mutate(perc_changeLag = lag(perc_change, 120),
         ...
         incumbentLag = lag(incumbent, 120))
```
