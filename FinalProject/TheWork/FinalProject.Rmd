...
Resultsmodel <- Results %>%
  mutate(perc_changeLag2 = lag(perc_change, 120),
         ApproveLag2 = lag(Approve, 120),
         incumbentpartyLag2 = lag(incumbentparty, 120),
         perc_DemLag2 = lag(perc_Dem, 120),
         perc_prez_DemLag2 = lag(perc_prez_Dem, 120),
         perc_gub_DemLag2 = lag(perc_gub_Dem, 120),
         perc_sen_DemLag2 = lag(perc_sen_Dem, 120))
...
Resultsmodel <- Resultsmodel %>%
  mutate(perc_prez_DemLag2 = lag(perc_prez_Dem, 240),
         perc_gub_DemLag2 = lag(perc_gub_Dem, 240),
         perc_sen_DemLag2 = lag(perc_sen_Dem, 240),
         mid_penalty = prez_party*mid_penalty,
